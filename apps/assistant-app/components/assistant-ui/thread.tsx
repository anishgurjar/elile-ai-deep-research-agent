...
const AssistantActionBar: FC = () => {
  return (
    ...
    >
      ...
      {/* TODO: Implement reload/regenerate functionality
      ...
      <ThreadPrimitive.If running={false}>
        <ComposerPrimitive.Send asChild>
          <TooltipIconButton
            ...
            variant="default"
            size="icon"
            className="aui-composer-send size-[34px] rounded-full p-1 bg-[var(--elileai-link)] hover:bg-[var(--elileai-link-hover)]"
      ...
      <ThreadPrimitive.If running>
        <ComposerPrimitive.Cancel asChild>
          <Button
            ...
            variant="default"
            size="icon"
            className="aui-composer-cancel size-[34px] rounded-full bg-[var(--elileai-link)] hover:bg-[var(--elileai-link-hover)]"
  ...
  return (
    <div className="aui-composer-wrapper sticky bottom-0 mx-auto flex w-full max-w-[var(--thread-max-width)] flex-col gap-4 overflow-visible rounded-t-3xl bg-background pb-4 md:pb-6">
      ...
      <p className="text-xs text-center text-muted-foreground">
        ELILEAI Assistant can make mistakes. Please double check your work.
      </p>
    </div>
  );
};
    ...
    <div className="aui-thread-welcome-root mx-auto my-auto flex w-full max-w-[var(--thread-max-width)] flex-grow flex-col">
      <div className="aui-thread-welcome-center flex w-full flex-grow flex-col items-center justify-center">
        <div className="aui-thread-welcome-message flex size-full flex-col justify-center px-8">
          ...
          >
            <span className="text-[var(--elileai-link)]">Hello</span> there!
          </m.div>
          <m.div
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
